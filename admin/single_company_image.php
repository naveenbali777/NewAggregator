  ...
  <div class="row content">
    ...
    <div class="col-sm-9">
      <div class="row BoxOuter">
		<div class="col-sm-12">
			<h2 class="heading"><?php echo strtoupper($ticker); ?> Company Images</h2>
		</div>
		<div class="col-sm-12">
		...
		<div class="col-sm-12">
			<div class="row">
				<?php foreach ($dataArray as $key => $value) { 
					$imgLink = (stristr($value['image_link'], "http")) ? $value['image_link'] : "http://".$value['image_link'];
				?>
				<div class="col-sm-2 fixHeight">
					<a target="_blank" href="<?php echo $imgLink; ?>"><img src="<?php echo $imgLink; ?>"></a>
					<div class="actionBox">
