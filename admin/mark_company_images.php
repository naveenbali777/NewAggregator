...
$condition = ($ticker != "") ? " where channel LIKE '$ticker' and `status` = 'yes' GROUP BY channel" : " where `status` = 'yes' GROUP BY channel";
if(!empty($ticker)){
  ...
  <div class="row content">
    ...
    <div class="col-sm-9">
      <div class="row BoxOuter">
		<div class="col-sm-12">
			<h2 class="heading">Selected Company Images</h2>
		</div>
		<div class="col-sm-12">
			<form method="get">
				<div class="row">
					...
					<div class="col-sm-2">
						<?php if ($totalCount > 0){ ?>
							<a href="image_csv.php" class="btn btn-default">Export Csv</a>
						<?php } ?>
					</div>
				</div>
			</form>
		      	...
		      	<table class="table table-fixed">
					...
					<tbody>
						...
						<tr>
							...
							<td class="col-sm-6"><a href="mark_single_company_image.php?tkr=<?php echo $value['channel']; ?>"><?php echo $value['cnt']; ?></a></td>
						</tr>
						<?php } ?>
					</tbody>
				</table>
