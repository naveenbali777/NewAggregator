...
$condition = (!empty($condition)) ? $condition." and ".article_table.".status = '0'" : $condition." where ".article_table.".status = '0'";
...
$categoryArray = $fun->getcategorygroupby(" where ".article_table.".status = '0'");
$websiteArray = $fun->getwebsitesgroupby(" where ".article_table.".status = '0'");
