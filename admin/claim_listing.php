...
$page_name = "claim_listing.php";
$page = (!empty($_GET['page'])) ? $_GET['page'] : 1;
$index = 20;
$start = ($page == 1) ? 0 : ($page-1)*$index;
$extraprm = "";
$condition = "";
$totalCount = $fun->recordCountGb("claim_listing", $condition);
$condition = $condition." limit $start,$index";
$from = ($start == 0) ? 1 : $start+1;
$to = $start+$index;
$to = ($to <= $totalCount) ? $to : $totalCount;

$dataArray = $fun->getTableData("claim_listing",$condition);
  ...
  <div class="row content">
    ...
    <div class="col-sm-9">
      <div class="row BoxOuter">
		<h2 class="heading">Claim Listing</h2>
		<div class="col-sm-12">
