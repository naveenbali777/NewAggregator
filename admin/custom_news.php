...
$condition = (!empty($condition)) ? $condition." and ".article_table.".status = '0' and ".article_table.".custom_news = '1'" : $condition." where ".article_table.".status = '0' and ".article_table.".custom_news = '1'";
...
$dataArray = $fun->getcustomnews($condition);
$categoryArray = $fun->getcategorygroupby(" where ".article_table.".status = '0' and ".article_table.".custom_news = '1'");

if(isset($_POST['active'])){
	if(isset($_POST['articles'])){
		foreach ($_POST['articles'] as $key => $value) {
			$fun->activeNewsStatus($value);
		}
  ...
  <div class="row content">
    ...
    <div class="col-sm-9">
      <div class="row BoxOuter">
		<div class="col-sm-12">
			<h2 class="heading">Custom News <a class="btn btn-default pull-right" href="add_custom_news.php">Add Custom News</a></h2>
		</div>
		<div class="col-sm-12">
			<form method="get">
				<div class="row">
		      	...
		      	<table class="table table-fixed">
					...
					<tbody>
						...
						<tr>
							...
							<td class="col-xs-3"><?php echo $value['article_title']; ?></td>
							<td class="col-xs-1"><?php echo $value['category_name']; ?></td>
							<td class="col-xs-2"><?php echo $value['article_author']; ?></td>
							...
							<td class="col-xs-2"><a href="custom_news_detail.php?id=<?php echo $value['id']; ?>">View</a> | <a href="edit_custom_news.php?id=<?php echo $value['id']; ?>">Edit</a></td>
						</tr>
						<?php 
						$count++;
						} ?>
		...
		<!-- <div class="col-sm-12">
		<?php if($count > 1){ ?>
			<input type="submit" name="active" value="Approve News">			
		<?php } ?>
		</div> -->
		<!-- </form> -->
		<div class="col-sm-12">
